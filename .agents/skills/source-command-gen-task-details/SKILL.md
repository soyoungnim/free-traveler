---
name: "source-command-gen-task-details"
description: "TASKS/00_TASK_LIST.md의 각 행에 대해 누락된 TASKS/TASK-<ID>.md를 생성한 뒤 scripts/audit_tasks.py로 감사한다."
---

# source-command-gen-task-details

Use this skill when the user asks to run the migrated source command `gen-task-details`.
