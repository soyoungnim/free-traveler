# CMP-SCR003-TAB-SHELL — 항공/숙소/동행 탭 셸

- **Category:** COMPONENT
- **Implementation Status:** IMPLEMENT
- **Priority:** P0
- **소스:** `TASKS/00_TASK_LIST.md` Seq 18

## Context

**CMP-SCR003-TAB-SHELL — 항공/숙소/동행 탭 셸** (Component 구현). Screen `SCR-003`(Route `/travel-tools`)의 일부로 동작한다. 우선순위 P0, Depends On: -.
...
(구조 — REQ-FUNC-011,019,027의 탭 프레임)
...
`src/app/_components/scr003/TabShell.tsx`(create)

> 이 Task는 위에 나열된 파일 외 어떤 파일도 생성·수정하지 않는다.

## Functional AC

탭 3개 전환, `tab_state_isolation_required` 준수(탭 전환 시 다른 탭 값 유지·혼입 없음)

## Visual AC

활성 탭 코랄 언더라인, Intro 1~3문장
...
- TC1: 항공/숙소/동행 탭 셸의 Functional AC에 기술된 각 동작이 지정된 입력에 대해 명세대로 동작한다.
