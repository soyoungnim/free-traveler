# CMP-SCR002-HERO-STATS — 대표 Hero + 여행 지표

- **Category:** COMPONENT
- **Implementation Status:** IMPLEMENT
- **Priority:** P0
- **소스:** `TASKS/00_TASK_LIST.md` Seq 12

## Context

**CMP-SCR002-HERO-STATS — 대표 Hero + 여행 지표** (Component 구현). Screen `SCR-002`(Route `/about`)의 일부로 동작한다. 우선순위 P0, Depends On: DATA-REPRESENTATIVE.
...
`src/app/_components/scr002/ProfileHeroStats.tsx`(create)

> 이 Task는 위에 나열된 파일 외 어떤 파일도 생성·수정하지 않는다.

## Functional AC

대표명·50+ Trips·30+ Countries·한 줄 소개 표시, Hero 높이 제한; Lorem ipsum 금지

## Visual AC

Stat 카드 3개, 코랄 강조 없이 ink 텍스트
...
- TC1: 대표 Hero + 여행 지표의 Functional AC에 기술된 각 동작이 지정된 입력에 대해 명세대로 동작한다.
