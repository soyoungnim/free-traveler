# DATA-REPRESENTATIVE — free_traveler 대표 프로필 정적 데이터

- **Category:** DATA
- **Implementation Status:** IMPLEMENT
- **Priority:** P0
- **소스:** `TASKS/00_TASK_LIST.md` Seq 40

## Context

**DATA-REPRESENTATIVE — free_traveler 대표 프로필 정적 데이터** (정적 데이터 구현). 특정 Screen에 종속되지 않는 공용/기반 Task다. 우선순위 P0, Depends On: -.
...
`src/data/representative/profile.ts`(create)

> 이 Task는 위에 나열된 파일 외 어떤 파일도 생성·수정하지 않는다.

## Functional AC

대표명·50+ Trips·30+ Countries 단일 소스, 소개문·철학, 방문국가 30개+, Timeline 6+, 추천 여행지 참조 4개, 이미지 8장+
