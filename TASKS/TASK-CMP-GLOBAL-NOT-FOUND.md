# CMP-GLOBAL-NOT-FOUND — 404 오류 화면

- **Category:** COMPONENT
- **Implementation Status:** IMPLEMENT
- **Priority:** P1
- **소스:** `TASKS/00_TASK_LIST.md` Seq 34

## Context

**CMP-GLOBAL-NOT-FOUND — 404 오류 화면** (Component 구현). 특정 Screen에 종속되지 않는 공용/기반 Task다. 우선순위 P1, Depends On: CMP-GLOBAL-HEADER-FOOTER.
...
홈으로/이전 페이지 복구 행동 최소 1개

## Visual AC

D-001 톤 유지(별도 다크 배경 없음)
...
- TC1: 404 오류 화면의 Functional AC에 기술된 각 동작이 지정된 입력에 대해 명세대로 동작한다.
