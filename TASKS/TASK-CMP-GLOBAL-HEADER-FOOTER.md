# CMP-GLOBAL-HEADER-FOOTER — 전역 Header/Footer

- **Category:** COMPONENT
- **Implementation Status:** IMPLEMENT
- **Priority:** P0
- **소스:** `TASKS/00_TASK_LIST.md` Seq 30

## Context

**CMP-GLOBAL-HEADER-FOOTER — 전역 Header/Footer** (Component 구현). 특정 Screen에 종속되지 않는 공용/기반 Task다. 우선순위 P0, Depends On: CMP-GLOBAL-DESIGN-TOKENS.
...
5개 Screen 공통 내비게이션(홈/대표소개/여행준비/동행찾기/계정)·Footer(서비스/정책/문의 3열), 320px부터 반응형

## Visual AC

Header 80px Desktop/64px Mobile, Footer 흰 배경
...
- TC1: 전역 Header/Footer의 Functional AC에 기술된 각 동작이 지정된 입력에 대해 명세대로 동작한다.
- TC2: Requirement Ref에 나열된 각 REQ 항목의 수용 기준을 개별적으로 만족한다.
- TC3: Visual AC에 기술된 D-001 토큰(색상/모양/여백)만 사용하고 임의 색상이 없다.

## Verify

E2E-PUBLIC-SMOKE, E2E-TRAVEL-TOOLS, E2E-MATE-AUTH
...
- [ ] Test Cases 전항목 통과
- [ ] Verify에 명시된 Task(E2E-PUBLIC-SMOKE, E2E-TRAVEL-TOOLS, E2E-MATE-AUTH)와 연동 확인
