# CMP-SCR002-BIO — 소개·철학 문단

- **Category:** COMPONENT
- **Implementation Status:** IMPLEMENT
- **Priority:** P0
- **소스:** `TASKS/00_TASK_LIST.md` Seq 13

## Context

**CMP-SCR002-BIO — 소개·철학 문단** (Component 구현). Screen `SCR-002`(Route `/about`)의 일부로 동작한다. 우선순위 P0, Depends On: DATA-REPRESENTATIVE.
...
`src/app/_components/scr002/BioPhilosophy.tsx`(create)

> 이 Task는 위에 나열된 파일 외 어떤 파일도 생성·수정하지 않는다.

## Functional AC

자기소개·시작 이유·철학 2~4문단, 좌측 텍스트/우측 사진; Lorem ipsum 금지
...
- TC1: 소개·철학 문단의 Functional AC에 기술된 각 동작이 지정된 입력에 대해 명세대로 동작한다.
