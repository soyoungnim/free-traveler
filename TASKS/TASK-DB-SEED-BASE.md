...
- **Priority:** P1
- **소스:** `TASKS/00_TASK_LIST.md` Seq 44

## Context

**DB-SEED-BASE — 개발용 시드 데이터** (Database 구현). 특정 Screen에 종속되지 않는 공용/기반 Task다. 우선순위 P1, Depends On: DB-SCHEMA-BASE.
...
6개 테이블에 대한 최소 개발용 샘플 레코드(모집중 글, 요청, 신고 등 각 상태 1건 이상)
