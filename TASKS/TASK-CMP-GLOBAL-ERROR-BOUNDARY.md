# CMP-GLOBAL-ERROR-BOUNDARY — 500/권한없음/외부연결실패 오류 화면

- **Category:** COMPONENT
- **Implementation Status:** IMPLEMENT
- **Priority:** P1
- **소스:** `TASKS/00_TASK_LIST.md` Seq 35

## Context

**CMP-GLOBAL-ERROR-BOUNDARY — 500/권한없음/외부연결실패 오류 화면** (Component 구현). 특정 Screen에 종속되지 않는 공용/기반 Task다. 우선순위 P1, Depends On: CMP-GLOBAL-HEADER-FOOTER.
...
REQ-FUNC-078(500/권한없음/외부연결실패 부분)
...
재시도/홈 복구 행동 제공, 외부 사이트 연결 실패 시 전용 안내
...
오류 메시지에 내부 스택/민감정보 노출 금지

## Test Cases

- TC1: 500/권한없음/외부연결실패 오류 화면의 Functional AC에 기술된 각 동작이 지정된 입력에 대해 명세대로 동작한다.
...
- [ ] Test Cases 전항목 통과
- [ ] Verify에 명시된 Task(E2E-TRAVEL-TOOLS)와 연동 확인
